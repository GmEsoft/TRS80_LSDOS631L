...
The original source files come from the archive `Source code for LS-DOS 6.3.1H (19xx)(-)[DSK]` and were made available by Peter W. Cervasio. Here is the text of the HowTo.txt notice included in the archive:
